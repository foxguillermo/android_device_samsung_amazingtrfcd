...
adb pull /system/lib/egl/libEGL.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib/egl/libEGL.so
...
adb pull /system/lib/libOmxIttiamVdec.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib/
...
adb pull /system/lib/libOmxVp8Dec.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib/
...
adb pull /system/lib/libOmxrv9Dec.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib/

## BT
adb pull /system/etc/firmware/ath6k ../../../vendor/$VENDOR/$DEVICE/proprietary/etc/firmware/
